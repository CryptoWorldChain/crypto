...
JNIEXPORT jlong JNICALL Java_crypto_BrewchainCrypto_createContext(
...
JNIEXPORT void JNICALL Java_crypto_BrewchainCrypto_destroyContext(
...
JNIEXPORT jobjectArray JNICALL Java_crypto_BrewchainCrypto_createAccount(
        JNIEnv *env, jobject this, jlong context_)
{
    const void *context;
    uint8_t prikey[65];
...
JNIEXPORT jobjectArray JNICALL Java_crypto_BrewchainCrypto_recoverAccount(
...
JNIEXPORT jstring JNICALL Java_crypto_BrewchainCrypto_signTransaction(
        JNIEnv *env, jobject this, jlong context_, jstring prikey_,
...
JNIEXPORT jint JNICALL Java_crypto_BrewchainCrypto_verifySignature(
        JNIEnv *env, jobject this, jlong context_,
